...
def knapsack_dyna_hybrid(actions):
    ...
    for i in range(1, n + 1):
        action_cost_int = int(actions[i-1]['cost']) # Methode range() ne fonctionne pas avec un type float
    ...
    # Dictionnaire pour un accès rapide aux coûts et profits des actions par leur ID
    ...
    for combination_ids in dyna_combinations:
        ...
        # Ajouter la combinaison avec son coût et son profit à best_combinations
        min_budget + 10 <= total_cost <= max_budget - 10
