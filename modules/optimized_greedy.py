...
# Fonction de programmation sac à dos glouton
def knapsack_greedy(actions):
    ...
    # Parcourir les actions et les ajouter jusqu'à atteindre la limite de budget
    for action in actions:
        if total_cost + action['cost'] <= config.MAX_BUDGET:
            ...
            if min_budget <= total_cost:
                best_combinations.append([chosen_actions[:], total_cost, total_profit])
